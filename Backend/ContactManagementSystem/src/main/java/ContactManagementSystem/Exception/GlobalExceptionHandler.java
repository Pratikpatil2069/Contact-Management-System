...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ApiResponse<ContactModel>> MethodArgumentNotValid(MethodArgumentNotValidException ex){
		
		ApiResponse<ContactModel>response=new ApiResponse<>(false,"Validation failed", null,LocalDateTime.now());
